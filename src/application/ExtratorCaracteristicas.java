...
public class ExtratorCaracteristicas {
	...
	public static void extrair(boolean exibeImagem) {
		...
		for (File imagem : arquivos) {
			...
			System.out.println("Laranja camisa Bart: " + caracteristicas[cont][0] + " - Azul calção Bart: "
					+ caracteristicas[cont][1] + " - Azul sapato Bart: " + caracteristicas[cont][2]
					+ " - Azul calça Homer: " + caracteristicas[cont][3] + " - Marrom boca Homer: "
					+ caracteristicas[cont][4] + " - Preto sapato Homer: " + caracteristicas[cont][5] + " - Classe: "
					+ classe);
